...
student_info = PersonalInfo(id=1, name='Arsen', address='Lviv', email='someaddress@gmail.com',
                            phone_number='000000', position='Sophomore',
                            employed_year=datetime.datetime(2019, 8, 12))
arsen_student = Student(student_info, year=2019, student_id=12, lessons_amount=4)
arsen_student.__str__()
